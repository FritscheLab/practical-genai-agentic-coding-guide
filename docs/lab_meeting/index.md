...
The [45-minute runbook](45min_runbook.md) is a session you can lead with your group. Use the [six short steps](../lessons/index.md) to follow along or continue at home. Choose Python or R, install its dependencies, and render the baseline before the session; use the meeting for reasoning and review.
...
- [Demo prompts](demo_prompts.md): requests for orientation, implementation, and review.
...
Participants should leave with a readable plot, reviewed alternative text, a source change they understand, test results, and a short handoff. Accessibility is part of the task and review from the start.
