...
# Work through a change together

The [45-minute runbook](45min_runbook.md) is a session you can lead with your group. Use the [six short steps](../lessons/index.md) to follow along or continue at home. Choose the Python or R path, install its dependencies, and run its baseline before the session; use the meeting for reasoning and review.
